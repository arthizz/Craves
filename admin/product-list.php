            ...
            <div class="col-md-12">
                <table class="table">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td><?=$row['cID']?></td>
                      <td><?=$row['cProduct_name']?></td>
                      <td><?=$row['cProduct_category']?></td>
                      <td><?=$row['cProduct_price']?></td>
                      <td>

                        <button class="btn btn-success btn-xs" onClick="window.open('edititem.php?id=<?=$row['cID']?>', '_self',); window.close();" style="border-radius: 5px;"><i class="fas fa-pen-square"></i></button>
                       <button class="btn btn-danger btn-xs" style="border-radius: 5px;" onClick="window.open('delete.php?id=<?=$row['cID']?>', '_self',); window.close();"><i class="fas fa-trash-alt"></i></button>
