...
<body>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content mt-3">
            <div class="row">
                <div class="col-md-5">
                    <form method="post" action="../api/record.php">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Expenses" name="expenses">
                      </div>
                      <div class="form-group">
                        <label>Revenue</label>
                        <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Revenue" name="rev">
                      </div>
