			...
			<div class="container">
				<div class="pull-left">
					...
					<div class="header-search">
						<h1> Craves <span class="text-orange"> Avenue </span> </h1>
					</div>
					<!-- /Search -->
				</div>
			...
			<div class="home-wrap">
				...
				<div id="home-slick">
					...
					<div class="banner banner-1">
						<img src="./img/coffee.jpg" alt="" height="490">
						<div class="banner-caption text-center">
							<h1 class="white-color">Start your day with a cup of coffe</h1>
					...
					<!-- banner -->
					<div class="banner banner-1">
						<img src="./img/coffee2.jpg" alt="" height="490">
						<div class="banner-caption">
							<h1 class="primary-color">Bright your day with a hot morning<br>
							<button class="primary-btn">Order Now</button>
						</div>
					</div>
					<!-- /banner -->
					...
					<!-- banner -->
					<div class="banner banner-1">
						<img src="./img/coffee3.jpg" alt="" height="490">
						<div class="banner-caption">
							<h1 class="white-color">Brewed and Good</h1>
							<button class="primary-btn">Order Now</button>
						</div>
					</div>
					<!-- /banner -->
				...
				<div class="col-md-3 col-sm-6 col-xs-6">
					<div class="product product-single">
						<div class="product-thumb">
							...
							<img src="./img/expresso.jpg" alt="" height="220">
						</div>
						<div class="product-body">
							...
							<h2 class="product-name"><a href="#">Expresso</a></h2>
				...
				<div class="col-md-3 col-sm-6 col-xs-6">
					<div class="product product-single">
						<div class="product-thumb">
							...
							<button class="main-btn quick-view"><i class="fa fa-search-plus"></i> Quick view</button>
							<img src="./img/macchiato.jpg" alt="" height="220">
						</div>
						<div class="product-body">
							<h3 class="product-price">₱32.50</h3>
							<div class="product-rating">
							...
							<h2 class="product-name"><a href="#">Macchiato</a></h2>
							<div class="product-btns">
								<button class="main-btn icon-btn"><i class="fa fa-heart"></i></button>
								<button class="main-btn icon-btn"><i class="fa fa-exchange"></i></button>
								<button class="primary-btn add-to-cart"><i class="fa fa-shopping-cart"></i> Add to Cart</button>
				...
				<div class="col-md-3 col-sm-6 col-xs-6">
					<div class="product product-single">
						<div class="product-thumb">
							...
							<button class="main-btn quick-view"><i class="fa fa-search-plus"></i> Quick view</button>
							<img src="./img/classic.jpg" alt="" height="220">
						</div>
						<div class="product-body">
							<h3 class="product-price">₱32.50</h3>
							<div class="product-rating">
							...
							<h2 class="product-name"><a href="#">Classic Latte</a></h2>
							<div class="product-btns">
								<button class="main-btn icon-btn"><i class="fa fa-heart"></i></button>
								<button class="main-btn icon-btn"><i class="fa fa-exchange"></i></button>
								<button class="primary-btn add-to-cart"><i class="fa fa-shopping-cart"></i> Add to Cart</button>
				...
				<div class="col-md-3 col-sm-6 col-xs-6">
					<div class="product product-single">
						<div class="product-thumb">
							...
							<button class="main-btn quick-view"><i class="fa fa-search-plus"></i> Quick view</button>
							<img src="./img/wmilk.jpg" alt="" height="220">
						</div>
						<div class="product-body">
							<h3 class="product-price">₱32.50</h3>
							<div class="product-rating">
							...
							<h2 class="product-name"><a href="#">Coffee With Milk</a></h2>
							<div class="product-btns">
								<button class="main-btn icon-btn"><i class="fa fa-heart"></i></button>
								<button class="main-btn icon-btn"><i class="fa fa-exchange"></i></button>
								<button class="primary-btn add-to-cart"><i class="fa fa-shopping-cart"></i> Add to Cart</button>
			...
			<div class="row">
				...
				<div class="col-md-3 col-sm-6 col-xs-6">
					<div class="banner banner-2">
						<img src="./img/coffee.jpg" alt="" height="240">
						<div class="banner-caption">
				...
				<div class="col-md-3 col-sm-6 col-xs-6">
					<div class="product product-single">
						<div class="product-thumb">
							...
							<button class="main-btn quick-view"><i class="fa fa-search-plus"></i> Quick view</button>
							<img src="./img/irish.jpg" alt="" height="220">
						</div>
						<div class="product-body">
							<h3 class="product-price">₱32.50</h3>
							<div class="product-rating">
							...
							<h2 class="product-name"><a href="#">Irish</a></h2>
							<div class="product-btns">
								<button class="main-btn icon-btn"><i class="fa fa-heart"></i></button>
								<button class="main-btn icon-btn"><i class="fa fa-exchange"></i></button>
								<button class="primary-btn add-to-cart"><i class="fa fa-shopping-cart"></i> Add to Cart</button>
				...
				<div class="col-md-3 col-sm-6 col-xs-6">
					<div class="product product-single">
						<div class="product-thumb">
							...
							<button class="main-btn quick-view"><i class="fa fa-search-plus"></i> Quick view</button>
							<img src="./img/leche.jpg" alt="" height="220">
						</div>
						<div class="product-body">
							<h3 class="product-price">₱32.50</h3>
							<div class="product-rating">
							...
							<h2 class="product-name"><a href="#">Cafe Con Leche</a></h2>
							<div class="product-btns">
								<button class="main-btn icon-btn"><i class="fa fa-heart"></i></button>
								<button class="main-btn icon-btn"><i class="fa fa-exchange"></i></button>
								<button class="primary-btn add-to-cart"><i class="fa fa-shopping-cart"></i> Add to Cart</button>
				...
				<div class="col-md-3 col-sm-6 col-xs-6">
					<div class="product product-single">
						<div class="product-thumb">
							...
							<button class="main-btn quick-view"><i class="fa fa-search-plus"></i> Quick view</button>
							<img src="./img/turkish.jpg" alt="" height="220">
						</div>
						<div class="product-body">
							<h3 class="product-price">₱32.50</h3>
							<div class="product-rating">
							...
							<h2 class="product-name"><a href="#">Turkish</a></h2>
							<div class="product-btns">
								<button class="main-btn icon-btn"><i class="fa fa-heart"></i></button>
								<button class="main-btn icon-btn"><i class="fa fa-exchange"></i></button>
								<button class="primary-btn add-to-cart"><i class="fa fa-shopping-cart"></i> Add to Cart</button>
