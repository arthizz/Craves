						...
						<li class="header-cart dropdown default-dropdown">
							<a class="dropdown-toggle" data-toggle="dropdown" aria-expanded="true">
								<div class="header-btns-icon">
									...
									<?php
									$statement = $conn->prepare("SELECT * FROM waiter_cart_tbl WHERE user_id = :id");
							...
							<div class="custom-menu">
								<div id="shopping-cart">
									<div class="shopping-cart-list">
										<?php
										$stmt = $conn->prepare("SELECT DISTINCT cPrice FROM waiter_cart_tbl where user_id = :id");
										...
										while($row = $stmt->fetch(PDO::FETCH_ASSOC)){
												$sth = $conn->prepare("SELECT * FROM waiter_cart_tbl WHERE cPrice = :img");
									...
									<div class="shopping-cart-btns">
										...
										<a href="../api/waiter_checkout_process.php?id=<?php echo $_SESSION['user'];?>"><button class="primary-btn"> Submit <i class="fa fa-arrow-circle-right"></i></button></a>
								...
								<div class="product product-single">
									...
									<div class="product-body">
										...
										<div class="product-btns">
												<div class="row">
													<form action="../api/add-cart-waiter.php?id=<?=$row['cID']?>" method="post">
														<div class="col-md-6">
															<button type="submit" class="primary-btn add-to-cart btn-block"><i class="fa fa-shopping-cart"></i> Add to Cart</button>
															
														</div>
														<div class="col-md-6">
															<div class="qty-input">
																<input class="input" type="number" id="qty" min="1" value="1" name="quant">
															</div>
														</div>
													</form>
												</div>
