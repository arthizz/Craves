					...
					<!-- <div class="header-search">
						<form>
							...
							<select class="input search-categories">
								...
								<option value="1">Cold Beverages</option>
								<option>Pasta</option>
				...
				<div id="main" class="col-md-12">
					...
					<div id="store">
						...
						<div class="row">
							...
							<?php
							$stmt = $conn->prepare("SELECT * FROM gallery_tbl");
							$stmt->execute();
							...
							<div class="col-md-4 col-sm-6 col-xs-6">
								<div class="product product-single">
									<div class="product-thumb">
										...
										<button class="main-btn quick-view" data-toggle="modal" data-target="#<?=$row['cID']?>"><i class="fa fa-search-plus"></i> Quick view</button>
										<img src="./img/<?=$row['cImg']?>" alt="" height="230">
									</div>
							  ...
							  <div class="modal-dialog" role="document">
							    <div class="modal-content">
							      <div class="modal-header">
							        <h5 class="modal-title" id="exampleModalLabel">Pictures & Caption</h5>
							      ...
							      <div class="modal-body">
							        <div class="container-fluid">
							        	<div class="col-md-12 mx-auto">
							        		<img src="img/<?=$row['cImg']?>" alt="" class="center" height="300" width="400">
							        		<br>
							        		<hr>
							        		<h3 style="margin-left: 150px;"><?=$row['cCaption']?></h3>
							        	</div>
							        </div>
							      </div>
